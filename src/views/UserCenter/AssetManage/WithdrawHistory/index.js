...
@autobind
export default class widthdrawHistory extends React.Component {
    state = {
        selectCurrency: 'BTC',
        histtoryList: {},
        coinList: [],
    ...
    render() {
        const { selectCurrency, histtoryList, coinList, pageKeys } = this.state;
        return (
            <div className="recharge-history" style={{ backgroundColor: "#162345" }}>
                <h2 className="userCenterav">提现历史</h2>
